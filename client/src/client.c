...
static void *make_request() {
  ...
  printf("Thread id %lu was created successfully\n", t_id);
  int cycles = 1;
...
//  printf("ncycles %i\n", ncycles);
  ...
  while(cycles <= ncycles){
	...
	printf("\n********** Executing cycle %i of %i in thread: %lu **********\n\n", cycles, ncycles, t_id);
...
*/
	...
	printf("(%lu: %i/%i) Total bytes readed: %i\n", t_id, cycles, ncycles, total_size);
